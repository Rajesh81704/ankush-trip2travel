...
export async function GET(
  ...
  try {
    ...
    console.error('[PROXY] GET error:', error, 'cause:', error?.cause);
    return NextResponse.json(
      { success: false, message: 'Proxy error', error: String(error), cause: String(error?.cause) },
      { status: 500 }
    );
  }
}
...
export async function POST(
  ...
  try {
    ...
    console.error('[PROXY] POST error target:', targetUrl, 'error:', error, 'cause:', error?.cause);
    return NextResponse.json(
      { success: false, message: 'Proxy error', error: String(error), cause: String(error?.cause), targetUrl },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    console.error('[PROXY] PUT error target:', targetUrl, 'error:', error, 'cause:', error?.cause);
    return NextResponse.json(
      { success: false, message: 'Proxy error', error: String(error), cause: String(error?.cause), targetUrl },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[PROXY] DELETE error target:', targetUrl, 'error:', error, 'cause:', error?.cause);
    return NextResponse.json(
      { success: false, message: 'Proxy error', error: String(error), cause: String(error?.cause), targetUrl },
      { status: 500 }
    );
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[PROXY] PATCH error target:', targetUrl, 'error:', error, 'cause:', error?.cause);
    return NextResponse.json(
      { success: false, message: 'Proxy error', error: String(error), cause: String(error?.cause), targetUrl },
      { status: 500 }
    );
