    ...
    if (presetModalType === "hotel") {
      ...
      const newFlights: FlightOption[] = selectedPresets.map((p) => {
        ...
        return {
          ...
          departureDate: "",
          arrivalCity: f.arrivalCity || p.destination || "",
          arrivalAirport: "",
      ...
      setValue("flights", [...current, ...newFlights], { shouldDirty: true, shouldTouch: true });
      setOpenSections((prev) => ({ ...prev, flights: true }));
      toast.success(`Imported ${newFlights.length} flight(s) from presets`);
    }
  };
